...
solutions_hybrid = evaluate(algorithm=moabc_nsga2_spea2, pf=true_pareto, SQ=sq, MCN=mcn, SN=sn, N=sn // 2)
solutions_hybridv0 = evaluate(algorithm=moabc_nsga2_v0, pf=true_pareto, SQ=sq, MCN=mcn, SN=sn, N=sn // 2)
...
print("Solutions SPEA2...", len (transform(solutions_spea2)))
print(transform(solutions_spea2))
print("Solutions MOABC...", len (transform(solutions_moabc)))
print(transform(solutions_moabc))
print("Solutions Hybride SPEA2...",len (transform(solutions_hybrid)))
print(transform(solutions_hybrid))
print("Solutions Hybride V0...", len (transform(solutions_hybridv0)))
