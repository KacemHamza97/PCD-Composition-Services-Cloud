...
from multi_objective_algorithms.algorithms import moabc, nsga2
from multi_objective_algorithms.algorithms.hybrid import moabc_nsga2
...
while True :
    ...
    solutions_moabc = moabc.moabc(actGraph, candidates,SQ = sq ,MCN=mcn,constraints=constraints)[0]
    paretosList.extend(solutions_moabc)


    print("Executing hybrid Algorithm ")
    solutions_hybrid = moabc_nsga2(actGraph, candidates,SQ = sq,MCN=mcn,constraints=constraints)[0]
    paretosList.extend(solutions_hybrid)

    print("Executing nsga2 Algorithm ")
    solutions_nsga2 = nsga2.nsga2(actGraph, candidates,G=mcn,constraints=constraints)[0]
