...
opt , _ , _ =  hybrid.ABCgenetic(actGraph, candidates,SN = sn , SQ = 100, MCN=mcn * 10,constraints=constraints, weights=weights)
print("\nDone !")

print("Executing Algorithm ")
start_time = time.time()
result , minQos , maxQos = hybrid.ABCgenetic(actGraph, candidates,SN = sn ,SQ=sq ,MCN=mcn,constraints=constraints, weights=weights)
